# NER из юридических документов с помощью YandexGPT

Извлечение именованных сущностей (реквизиты сторон, даты, суммы, сроки обязательств) из договоров через API YandexGPT с выдачей результата в структурированном JSON.
